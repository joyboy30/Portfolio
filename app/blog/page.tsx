  ...
  export default function BlogPage() {
    return (
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -top-40 left-1/2 h-[36rem] w-[36rem] -translate-x-1/2 rounded-full bg-accent/10 blur-[140px]"
        />

        <div
          aria-hidden="true"
          className="pointer-events-none absolute top-[40rem] right-0 h-[28rem] w-[28rem] rounded-full bg-accent-light/10 blur-[140px]"
        />

        {/* ---------------- Hero ---------------- */}
        <section className="relative mx-auto max-w-6xl px-6 pb-20 pt-28 sm:pt-36 lg:px-8">
          <div className="mx-auto max-w-3xl text-center animate-fade-up">
            <span className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-4 py-1.5 text-xs font-medium tracking-wide text-accent-light shadow-glass backdrop-blur-sm">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-balance text-base leading-relaxed text-text sm:text-lg">
              I publish actionable SEO strategies, Google algorithm analysis,
              AI Search Optimization (AIO/AEO/GEO), Local SEO, Technical SEO,
              content marketing guidance, and real SEO case studies, using the
              same strategies I implement for real clients.
            </p>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link
                href="/"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-border-strong bg-surface px-7 py-3.5 text-sm font-medium text-foreground shadow-glass transition-all duration-300 hover:border-accent hover:text-accent-light"
              >
        ...
        <section
          ...
          className="relative mx-auto max-w-6xl px-6 py-16 lg:px-8"
        >
          <div className="mx-auto mb-12 max-w-2xl text-center">
            ...
            <p className="mt-3 text-sm text-muted sm:text-base">
              Every article is filed under the search discipline it actually
              belongs to.
            </p>
          </div>
            ...
            {categories.map((category) => {
              ...
              return (
                <Link
                  key={category.title}
                  href={category.href}
                  className="group relative flex flex-col rounded-3xl border border-border bg-surface-2 p-6 shadow-glass transition-all duration-300 hover:-translate-y-1 hover:border-accent hover:shadow-glow-sm"
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-accent/10 text-accent-light transition-colors duration-300 group-hover:bg-accent/20">
                  ...
                  <span className="mt-5 inline-flex items-center gap-1.5 text-sm font-medium text-accent-light">
                    View articles
                    <ArrowRight
        ...
        <section
          ...
          className="relative mx-auto max-w-6xl px-6 py-16 lg:px-8"
        >
          <div className="overflow-hidden rounded-[2.5rem] border border-border bg-gradient-to-b from-surface to-transparent p-8 shadow-glass sm:p-12">
            <div className="mx-auto mb-12 max-w-2xl text-center">
              <h2
              ...
              <p className="mt-3 text-sm text-muted sm:text-base">
                Written from active client engagements, not repackaged SEO
                listicles.
              </p>
            </div>
              ...
              {reasons.map((reason) => {
                ...
                return (
                  <div key={reason.title} className="flex gap-4">
                    <div className="flex h-10 w-10 flex-none items-center justify-center rounded-xl bg-surface text-accent-light">
                      <Icon className="h-5 w-5" aria-hidden="true" />
                    </div>
        ...
        <section
          ...
          className="relative mx-auto max-w-6xl px-6 py-16 lg:px-8"
        >
          <div className="rounded-[2.5rem] border border-border bg-gradient-to-b from-surface to-transparent px-8 py-16 text-center shadow-glass sm:px-14">
            <h2
              id="cta-heading"
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-text">
              If you need SEO consulting, Local SEO, Technical SEO, content
              marketing, AI Search Optimization, or a full website SEO audit, I
              work with businesses ready to take search visibility seriously.
              Let&rsquo;s talk about what that looks like for you.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
              ...
              {largeCtaLinks.map((link) => (
                <Link
                  key={link.label}
                  href={link.href}
                  className="inline-flex items-center gap-2 rounded-full border border-border-strong bg-surface px-7 py-3.5 text-sm font-medium text-foreground transition-all duration-300 hover:border-accent hover:text-accent-light"
                >
                  {link.label}
                </Link>
              ))}
        ...
        {/* ---------------- Footer ---------------- */}
        <footer className="relative border-t border-border px-6 py-12 lg:px-8">
          <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 text-center sm:flex-row sm:justify-between sm:text-left">
            <Link
              href="/"
              className="flex items-center gap-2 text-sm font-semibold text-foreground"
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-accent-gradient text-xs font-bold text-background">
                IC
              </span>
              Igel Cudiera
            </Link>
          ...
          <div className="mx-auto mt-8 flex max-w-6xl flex-col items-center gap-1 border-t border-border pt-8 text-center text-xs text-muted-2 sm:flex-row sm:justify-between sm:text-left">
